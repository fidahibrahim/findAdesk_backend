...
class ownerUseCase {
    constructor(ownerRepository, HashingService, otpService, jwtService) {
    ...
    async ownerVerifyOtp(email, otp) {
        try {
    ...
    async login(data) {
        try {
            ...
            if (ownerData) {
                ...
                const status = await this.hashingService.compare(data.password, ownerData.password);
                if (!status) {
                    return {
                        status: false,
...
exports.default = ownerUseCase;
//# sourceMappingURL=ownerUseCase.js.map